...
exports.setClassMembers = setClassMembers;
...
function setClassMembers(j, classComp, members) {
    var body = classComp.node.body.body;
    members.forEach(function (member) {
        var alreadyExist = body.find(function (prop) {
            return isPropertyWithName(j, member, prop);
        });
        var typeAnnotation = member === 'state' ? j.typeAnnotation(j.genericTypeAnnotation(j.identifier('Object'), null)) : j.typeAnnotation(j.anyTypeAnnotation());
        if (alreadyExist) {
