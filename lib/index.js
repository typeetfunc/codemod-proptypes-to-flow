...
function transformer(file, api, options) {
    ...
    return exportFile ? [root.toSource(config.generate, useIsPretty), { path: exportFile.path, source: exportFile.programNode.toSource(config.generate) }] : root.toSource(config.generate, useIsPretty);
}
